...
class Game:
    ...
    def _do_round(self):
        ...
        while(True):
            ...
            zilch_check_score = self._calculate_score(roll)
    ...
    def _validate_roll(self, roll):
        ...
        while True:
            ...
            if self._validate(roll, keepers):
                return keepers
            else:
    ...
    def _validate(self, roll, keepers):
    ...
    def _calculate_score(self, dice):
